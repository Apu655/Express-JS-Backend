const {create,getUsers,getUserByEmail,deleteUser} = require("./user.service")
...
module.exports={
        ...
        create(body,(err,results)=>{
            if (err){
                return res.status(500).json({
                    success:0,
                    message:"Database connection error./email already"
    ...
    login:(req,res)=>{
        ...
        getUserByEmail(email,(err,results)=>{
            ...
            const result = compare(results.password,password);
            if(result){
